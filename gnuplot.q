makePlottable:{[t]update timestamp:{{(10#x),"-",11 8 sublist x} string x} each timestamp from t}
...
// NB: t must have columns in the order timestamp-open-high-low-close, with types "pffff"
...
plotcpy:{[currencyPair;year;plotTitle]
